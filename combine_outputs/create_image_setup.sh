...
cp ./asciigrid_combined/dev/dev_maturity_groups_historical.asc.gz ./ascii_source/density_II_historical.asc.gz
cp ./asciigrid_combined/dev/dev_maturity_groups_future.asc.gz ./ascii_source/density_II_future.asc.gz
cp ./asciigrid_combined/dev/dev_maturity_groups_historical.asc.gz ./ascii_source/density_000_historical.asc.gz
cp ./asciigrid_combined/dev/dev_maturity_groups_future.asc.gz ./ascii_source/density_000_future.asc.gz
