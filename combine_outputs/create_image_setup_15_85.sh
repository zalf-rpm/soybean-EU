...
cat ${SOURCEFOLDER}/asciigrid_combined/dev/dev_allRisks_5_historical_crunched.asc.meta ./with_85/yLabel_latidude.meta > ${TARGETFOLDER}/dev_allRisks_5_historical_crunched.asc.meta
cp ${SOURCEFOLDER}/asciigrid_combined/dev/dev_allRisks_5_historical_crunched.asc.gz ${TARGETFOLDER}/dev_allRisks_5_historical_crunched.asc.gz
sed -i 's/title: .*/title: a/g' ${TARGETFOLDER}/dev_allRisks_5_historical_crunched.asc.meta
cat ${SOURCEFOLDER}/asciigrid_combined/dev/dev_allRisks_5_future_crunched.asc.meta ./with_85/yLabel_latidude.meta > ${TARGETFOLDER}/dev_allRisks_5_future_crunched85.asc.meta
cp ${SOURCEFOLDER}/asciigrid_combined/dev/dev_allRisks_5_future_crunched.asc.gz ${TARGETFOLDER}/dev_allRisks_5_future_crunched85.asc.gz
sed -i 's/title: .*/title: c/g' ${TARGETFOLDER}/dev_allRisks_5_future_crunched85.asc.meta
cat ${SOURCEFOLDER45}/asciigrid_combined/dev/dev_allRisks_5_future_crunched.asc.meta  ./with_85/yLabel_latidude.meta > ${TARGETFOLDER}/dev_allRisks_5_future_crunched45.asc.meta
cp ${SOURCEFOLDER45}/asciigrid_combined/dev/dev_allRisks_5_future_crunched.asc.gz ${TARGETFOLDER}/dev_allRisks_5_future_crunched45.asc.gz
sed -i 's/title: .*/title: b/g' ${TARGETFOLDER}/dev_allRisks_5_future_crunched45.asc.meta
...
cat ${SOURCEFOLDER}/asciigrid_combined/dev/all_historical_stdDev.asc.meta  ./with_85/yLabel_latidude.meta > ${TARGETFOLDER}/all_historical_stdDev.asc.meta
